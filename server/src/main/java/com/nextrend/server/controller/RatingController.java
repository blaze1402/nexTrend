...
import com.nextrend.server.service.RatingService;
...
public class RatingController {
    ...
    public ResponseEntity<List<Rating>> getProductRatings(@PathVariable("productId") Long productId, @RequestHeader("Authorization") String jwt) throws UserException, ProductException{
