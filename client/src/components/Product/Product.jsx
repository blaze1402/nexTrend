...
import { FormLabel, Pagination, Radio, RadioGroup } from '@mui/material'
...
export default function Product() {
    ...
    }, [param.levelThree, colorValue, sizeValue, priceValue, discountValue, sortValue, pageNumber, stockValue])
                                                ...
                                                <>
                                                    ...
                                                    <Disclosure.Panel className="pt-6">
                                                        <div className="space-y-4">
                                                            <FormControl >
                                                                <RadioGroup
                                                                    // key={optionIdx} // Add a unique key for each RadioGroup
