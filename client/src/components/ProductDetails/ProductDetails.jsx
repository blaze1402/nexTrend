...
export default function ProductDetails() {
  ...
  const rawData = {
    ...
    breadcrumbs: [
      { id: 1, name: product.product?.category.parentCategory.parentCategory.name, href: '#' },
      { id: 2, name: product.product?.category.parentCategory.name, href: '#' },
    ]
  }
      ...
      <div className="pt-6">
        <nav aria-label="Breadcrumb">
          <ol role="list" className="mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            {rawData.breadcrumbs.map((breadcrumb) => (
            ...
            <li className="text-sm">
              <a href='#' aria-current="page" className="font-medium text-gray-500 hover:text-gray-600">
                {product.product?.category.name.split('_').map((str) => str.charAt(0).toUpperCase() + str.slice(1)).join(' ')}
              </a>
            </li>
          </ol>
        </nav>
        ...
        <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10'>
          ...
          <div className="flex flex-col items-center pt-2">
            ...
            {/* <div className="flex flex-wrap space-x-5 justify-center">
              {p1.images.map((item) => <div key={item.src} className="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg max-w-[5rem] max-h-[5rem] mt-4">
                <img
                  src={item.src}
                  alt={item.alt}
                  className="h-full w-full object-cover object-center"
          ...
          <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className='flex space-x-5 items-center text:lg lg-text-xl mt-6 text-gray-900'>
                ...
                <p className='text-green-500 font-semibold '>{product.product?.discountPercent}% Off</p>
              </div>
              ...
              <div className="mt-6">
                <div className='flex items-center space-x-3'>
                  ...
                  <p className='text-sm opacity-50'>32 ratings</p>
                  <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-400'>21 reviews</p>
                </div>
              </div>
              ...
              <form>
                ...
                <div className="mt-5">
                  ...
                  <RadioGroup value={selectedSize} onChange={setSelectedSize} className="mt-2 mb-5">
            ...
            <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
              ...
              <div className="mt-7">
                ...
                <div className="mt-4">
                  <ul role="list" className="list-disc space-y-2 pl-4 text-sm">
                    {rawData.highlights.map((highlight) => (
              ...
              {/* <div className="mt-10">
                ...
                <div className="mt-4 space-y-6">
                  <p className="text-sm text-gray-600">{p1.details}</p>
                </div>
              </div> */}
            </div>
          </div>
            ...
            <Grid container spacing={7}>
              <Grid item xs={7}>
                <div className='space-y-5'>
                  {[1, 1, 1].map((review, index) => <ProductReviewCard reviews={review} key={index} />)}
                  {/* {product.product?.reviews.map((review, index) => <ProductReviewCard reviews={review} key={index} />)} */}
                </div>
              </Grid>
              <Grid item xs={5}>
                ...
                <div>
                  ...
                  <p className='opacity-60'>32 Ratings</p>
                </div>
