        ...
        <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10'>
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="flex flex-wrap space-x-5 justify-center">
              {product.images.map((item) => <div key={item.src} className="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg max-w-[5rem] max-h-[5rem] mt-4">
                <img
                  src={item.src}
                  alt={item.alt}
                  className="h-full w-full object-cover object-center"
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                <div className='flex items-center space-x-3'>
                  ...
                  <p className='text-sm opacity-50'>54364 ratings</p>
                  <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-400'>3422 reviews</p>
                </div>
              </div>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                ...
                <div>
                  ...
                  <p className='opacity-60'>434324 Ratings</p>
                </div>
